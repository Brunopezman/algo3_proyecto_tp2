...
public class ComodinMultiplicadorTests {
    private static final char SIMBOLOSUMAR = '+';
    private static final char SIMBOLOMULTIPLICAR = '*';

    @Test
    public void testComodinSumaAlMultiplicadorCorrectamente(){
        Jugada jugada = new Jugada(new Color(), 1, 20);
        Comodin comodin = new ComodinMultiplicador(10, SIMBOLOSUMAR);
    ...
    @Test
    public void testComodinMultiplicaAlMultiplicadorCorrectamente(){
        Jugada jugada = new Jugada(new Color(), 1, 20);
        Comodin comodin = new ComodinMultiplicador(10, SIMBOLOMULTIPLICAR);
        comodin.aplicarEfecto(jugada);
